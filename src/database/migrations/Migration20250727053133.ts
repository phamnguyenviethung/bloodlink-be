...
export class Migration20250727053133 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "blood_unit_actions" alter column "created_at" set default '2025-07-27T05:31:33.228Z';`);
    this.addSql(`alter table "blood_unit_actions" alter column "updated_at" type timestamptz using ("updated_at"::timestamptz);`);
    this.addSql(`alter table "blood_unit_actions" alter column "updated_at" set default '2025-07-27T05:31:33.228Z';`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "campaign_donation_log" add constraint "campaign_donation_log_status_check" check("status" in ('completed', 'result_returned', 'appointment_confirmed', 'appointment_cancelled', 'appointment_absent', 'customer_cancelled', 'customer_checked_in', 'not_qualified', 'no_show_after_checkin', 'customer_checked_in', 'not_qualified', 'no_show_after_checkin'));`);
