...
export class Migration20250716033941 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "donation_result_template_item" drop column "options";`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "donation_result_template_item" add column "options" text[] null;`);
    this.addSql(`alter table "donation_result_template_item" alter column "created_at" type timestamptz using ("created_at"::timestamptz);`);
