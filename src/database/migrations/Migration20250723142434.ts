...
export class Migration20250723142434 extends Migration {
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "donation_result" add column "blood_type" varchar(255) not null;`);
    this.addSql(`alter table "donation_result" alter column "created_at" type timestamptz using ("created_at"::timestamptz);`);
